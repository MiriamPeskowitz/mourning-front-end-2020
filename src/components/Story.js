...
const Story = () => {
	return (
		<div className="story">
			...
			<p>That's were this online space, Mourning, comes in. We need spaces to mourn, to grieve. Perhaps it's the chance to write out our feelings. To create a bit of an alter or remembrance site. To share with friends. Perhaps it's the chance to collect the many people -- close and far -- that meant something to us and who are no longer alive, a cemetery of our imaginations, for this moment.
			</p>
		</div>
	 )
}
